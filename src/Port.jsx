...
Source: https://sketchfab.com/3d-models/medieval-port-city-e66255aa77c041ed9517426ee0926856
Title: Medieval Port City
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF("/medieval_port_city.glb");

  console.log(nodes.Object_150)
  ...
  return (
    <RigidBody type="fixed" colliders={"trimesh"}>
      <group {...props} dispose={null} scale={100} position={[0,-100,0]}>
        <group rotation={[-Math.PI / 2, 0, 0]}>
          ...
          <mesh
            ...
            material={materials.Detector_Rail_0}
          />
          <mesh
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials.Glowstone_0}
          />
        </group>
      </group>
    </RigidBody>
...
useGLTF.preload("/medieval_port_city.glb");
